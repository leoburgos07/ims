(function ($) {
    ...
    $(".buttonSidebar").hover(function(){
        $(this).find(".imgAzul").css("display", "none");
        $(this).find(".textButtonSidebar").css("display","block");
        }, function(){
        $(this).find(".imgAzul").css("display","block");
        $(this).find(".textButtonSidebar").css("display","none");

      });
      if($(window).width() < 992)
{
    $(".textButtonSidebar").css("display","block");
} else {
    console.log("high")
}
