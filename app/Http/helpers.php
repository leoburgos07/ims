...
function delete_form($param, $label = ''){
	...
	$form .= HTML::decode(Form::button('<i class="fa fa-trash-o"></i> '.$label,['data-toggle' => 'tooltip','title' => 'Eliminar','class' => 'btn btn-danger btn-xs','data-submit-confirm-text' => 'Yes']));
